                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="tab-content" id="authTabContent">
                            ...
                            <div class="tab-pane fade show active" id="login">
                                ...
                                <!-- Google Login Button (Kerangka untuk Nanti) -->
                                <div class="text-center mt-4">
                                    <p class="text-muted">— atau —</p>
                                    <a href="google-login.php" class="btn btn-google w-100">
                                        <i class="fab fa-google me-2"></i> Lanjutkan dengan Google
                                    </a>
                                    <small class="text-muted d-block mt-2">
                                        <i class="fas fa-info-circle"></i> Fitur Google Login akan segera hadir
                                    </small>
                                </div>
                            </div>
